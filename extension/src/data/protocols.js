...
window.ALGO_PROTOCOLS = {
    "app.tinyman.org": {
        ...
        riskScore: 42,
        trustLevel: "Moderate",
        summary: "Tinyman is a known Algorand DEX. The main user risks are pool token quality, slippage, and liquidity fragmentation.",
        checks: [
    ...
    "app.folks.finance": {
        ...
        riskScore: 38,
        trustLevel: "Moderate",
        summary: "Folks Finance is a lending and DeFi protocol on Algorand. Main risks include liquidation, rate shifts, and collateral quality.",
        checks: [
    ...
    "vestige.fi": {
        ...
        riskScore: 28,
        trustLevel: "General",
        summary: "Vestige is generally a token analytics and market-tracking surface. Risks depend more on the asset under review than the page itself.",
        checks: [
